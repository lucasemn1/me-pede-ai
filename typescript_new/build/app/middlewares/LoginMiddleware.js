...
var LoginMiddleware = /** @class */ (function () {
    ...
    LoginMiddleware.userIsLogged = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var token;
            return __generator(this, function (_a) {
                token = req.headers.authorization;
                if (!token) {
                    return [2 /*return*/, res.status(401).json({ err: 'You are not logged in. Enter the token to continue.' })];
                }
                else if (!JWTUtil_1.default.isTokenValid(token)) {
                    return [2 /*return*/, res
                            .status(401)
                            .json({
