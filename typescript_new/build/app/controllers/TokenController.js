...
var TokenController = /** @class */ (function () {
    ...
    TokenController.store = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, connection, user, err_1;
                ...
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        if (!bcrypt.compareSync(password, user.password)) {
                            return [2 /*return*/, response.status(401).json({ error: 'The credentials entered are invalid.' })];
                        }
